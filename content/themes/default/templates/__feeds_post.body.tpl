...
<div class="post-header" xmlns="http://www.w3.org/1999/html">
        ...
        {if !$_shared && $user->_logged_in && $_get != "posts_information"}
            <div class="float-right dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right post-dropdown-menu">
                    {if $_post['manage_post'] && $_post['post_type'] == "product" && $_post['post_type'] == "project"}
                    ...
                    {if $_post['manage_post']}
                        ...
                        {elseif $_post['post_type'] == "project"}
                            <div class="dropdown-item pointer" data-toggle="modal" data-url="posts/project.php?do=edit&post_id={$_post['post_id']}">

                                <div class="action no-desc">
                                    <i class="fa fa-pencil-alt fa-fw"></i> {__("Edit Project")}
                                </div>
                            </div>
                        ...
                        <!-- Edit -->
                        <!-- Delete -->
                        {if $_post['post_type'] != "product" && $_post['post_type'] != "project"}
                        ...
                        {elseif $_post['post_type'] == "product"}
                            <div class="dropdown-item pointer js_delete-post">
                                <div class="action no-desc">
                                    <i class="fa fa-trash-alt fa-fw"></i> {__("Delete Product")}
                                </div>
                            </div>
                        {elseif $_post['post_type'] == "project"}
                            <div class="dropdown-item pointer js_delete-post">
                                <div class="action no-desc">
                                    <i class="fa fa-trash-alt fa-fw"></i> {__("Delete Project")}
                                </div>
                            </div>
    ...
    {elseif $_post['post_type'] == "project"}
        {__("added new project for people")}
...
<!-- post text -->
{if $_post['post_type'] != "product" && $_post['post_type'] != "project" && $_post['post_type'] !="article"}
    {if !$_shared}
    ...
    <div class="mt10">
        <div class="post-media">
            ...
            <div class="post-media-meta">
                ...
                <div class="text mb5">{html_entity_decode($_post['article']['text']|truncate:400)}</div>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        <audio id="audio-{$_post['audio']['audio_id']}" onplay="update_media_views('audio', {$_post['audio']['audio_id']})" controls preload="auto" style="width: 100%;">
                            <source src="{$system['system_uploads']}/{$_post['audio']['source']}" type="audio/mpeg">
                                ...
                                {if $_post['post_type'] == "album" || ($_post['post_type'] == "product" || $_post['post_type'] == "project" || $_post['photos_num'] > 0) || $_post['post_type'] == "photos" || $_post['post_type'] == "profile_picture" || $_post['post_type'] == "profile_cover" || $_post['post_type'] == "page_picture" || $_post['post_type'] == "page_cover" || $_post['post_type'] == "group_picture" || $_post['post_type'] == "group_cover" || $_post['post_type'] == "event_cover"}
                                    <div class="mt10 clearfix">
                                        <div class="pg_wrapper">
                                            {if $_post['photos_num'] == 1}
                                                <div class="pg_1x">
                                                    <a href="{$system['system_url']}/photos/{$_post['photos'][0]['photo_id']}" data-id="{$_post['photos'][0]['photo_id']}" data-image="{if $_post['photos'][0]['source'] !=''}{$system['system_uploads']}/{$_post['photos'][0]['source']}{else}{$system['system_url']}/content/themes/default/images/blank_product.jpg{/if}" data-context="{if $_post['post_type'] == 'product' || $_post['post_type'] == 'project'}post{else}album{/if}">
                                                        <img src="{if $_post['photos'][0]['source'] !=''}{$system['system_uploads']}/{$_post['photos'][0]['source']}{else}{$system['system_url']}/content/themes/default/images/blank_product.jpg{/if}">
                                                    </a>
                                                </div>
                                            {elseif $_post['photos_num'] == 2}
                                                {foreach $_post['photos'] as $photo}
                                                    <div class="pg_2x">
                                                        <a href="{$system['system_url']}/photos/{$photo['photo_id']}" data-id="{$photo['photo_id']}" data-image="{$system['system_uploads']}/{$photo['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$photo['source']}');"></a>
                                                    </div>
                                                {/foreach}
                                            {elseif $_post['photos_num'] == 3}
                                                <div class="pg_3x">
                                                    <div class="pg_2o3">
                                                        <div class="pg_2o3_in">
                                                            <a href="{$system['system_url']}/photos/{$_post['photos'][0]['photo_id']}"  data-id="{$_post['photos'][0]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][0]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][0]['source']}');"></a>
                                                        </div>
                                                    </div>
                                                    <div class="pg_1o3">
                                                        <div class="pg_1o3_in">
                                                            <a href="{$system['system_url']}/photos/{$_post['photos'][1]['photo_id']}" data-id="{$_post['photos'][1]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][1]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][1]['source']}');"></a>
                                                        </div>
                                                        <div class="pg_1o3_in">
                                                            <a href="{$system['system_url']}/photos/{$_post['photos'][2]['photo_id']}"  data-id="{$_post['photos'][2]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][2]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][2]['source']}');"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            {else}
                                                <div class="pg_4x">
                                                    ...
                                                    <div class="pg_1o3">
                                                        ...
                                                        <div class="pg_1o3_in">
                                                            <a href="{$system['system_url']}/photos/{$_post['photos'][3]['photo_id']}"  data-id="{$_post['photos'][3]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][3]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][3]['source']}');">
                                            ...
                                            {if $_post['post_type'] == "project"}
                                                <div class="container" style="text-align: center">
                                                    ...
                                                    <center><label class="form-control-label" style="font-size: 16px;color:#2b53a4"><strong>{__("Project Info")}</strong></label></center>
                                                    <fieldset>
                                                        <div class="container">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Project Name")}: </label> <strong>   {$_post['project']['name']}</strong>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Pattern")}: </label>    <p>{$_post['project']['pattern']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Craft")}: </label> <p>   {$_post['project']['craft']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Made for")}: </label> <p>   {$_post['project']['made']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Size")}: </label> <p>   {$_post['project']['size']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Start Date")}: </label> <p>   {$_post['project']['sta_date']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Completed Date")}: </label> <p>   {$_post['project']['fini_date']}</p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <center><label class="form-control-label" style="font-size: 16px;color:#2b53a4"><strong>{__("Needles & Yarn")}</strong></label></center>
                                                    <fieldset>
                                                        <div class="container">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Needle")}: </label> <p>   {$_post['project']['needle']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Yarn")}: </label> <p>   {$_post['project']['yarn']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Colorway")}: </label> <p>   {$_post['project']['colorway']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("How much")}: </label><p>   {$_post['project']['how_much']}</p>
                                                                </div>
                                                                <div class="row">
                                                                    <label class="form-control-label">{__("Dye lots")}: </label><p>   {$_post['project']['dye_lot']}</p>
                                                                </div>
                                                    ...
                                                    <center><label class="form-control-label" style="font-size: 16px;color:#2b53a4"><strong>{__("Notes")}</strong></label></center>
                                                    <fieldset>
                                                        <div class="container">
                                                            <div class="container">
                                                                {if !$_shared}
