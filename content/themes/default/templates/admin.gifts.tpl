    ...
    <div class="card-header with-icon">
        {if $sub_view == ""}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/gifts/add" class="btn btn-sm btn-primary">
                    <i class="fa fa-plus mr5"></i>{__("Add New Gift")}
                </a>
            </div>
        {else}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/gifts" class="btn btn-sm btn-light">
                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        {foreach $rows as $row}
                            <tr>
                                <td>{$row['gift_id']}</td>
                                <td><img src="{$system['system_uploads']}/{$row['image']}" width="96"></td>
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/gifts/edit/{$row['gift_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
