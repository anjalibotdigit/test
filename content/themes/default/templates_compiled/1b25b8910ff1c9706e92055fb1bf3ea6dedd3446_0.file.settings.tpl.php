<?php
/* Smarty version 3.1.33, created on 2019-09-24 15:11:43
  from '/home/cryptocodex/public_html/content/themes/default/templates/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d8a322f287371_38714371',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1b25b8910ff1c9706e92055fb1bf3ea6dedd3446' => 
    array (
      0 => '/home/cryptocodex/public_html/content/themes/default/templates/settings.tpl',
      1 => 1568278182,
      2 => 'file',
    ),
  ),
...
function content_5d8a322f287371_38714371 (Smarty_Internal_Template $_smarty_tpl) {
...
">
                                            ...
                                            <span class="form-text">
                                                <?php echo __("Your phone number i.e +12344567890");?>
...
">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-control-label"><?php echo __("Google+ Profile URL");?>
</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
...
?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['session']->value['session_token'] == $_smarty_tpl->tpl_vars['user']->value->_data['active_session']) {?><span class="badge badge-pill badge-lg badge-success"><?php echo __("Active Session");?>
</span><?php }?>
                                                </td>
                                        ...
                                        <div class="col-md-9">
                                            <?php if ($_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "both" || $_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "paypal") {?>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="method" id="method_paypal" value="paypal" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "paypal") {?>checked<?php }?>>
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "both" || $_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "skrill") {?>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="method" id="method_skrill" value="skrill" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['affiliate_payment_method'] == "skrill") {?>checked<?php }?>>
                                    ...
                                    <div class="form-group form-row">
                                        ...
                                        <div class="col-md-9">
                                            <?php if ($_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "both" || $_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "paypal") {?>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="method" id="method_paypal" value="paypal" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "paypal") {?>checked<?php }?>>
                                                    <label class="custom-control-label" for="method_paypal"><?php echo __("Paypal");?>
</label>
                                                </div>
                                            <?php }?>
                                            <?php if ($_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "both" || $_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "skrill") {?>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="method" id="method_skrill" value="skrill" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['points_payment_method'] == "skrill") {?>checked<?php }?>>
                                                    <label class="custom-control-label" for="method_skrill"><?php echo __("Skrill");?>
</label>
                                                </div>
                                            <?php }?>
